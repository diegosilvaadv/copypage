        ...
        body: SafeArea(
          ...
          child: FutureBuilder<List<UsersRow>>(
            ...
            builder: (context, snapshot) {
              ...
              List<UsersRow> templatesUsersRowList = snapshot.data!;
              final templatesUsersRow = templatesUsersRowList.isNotEmpty
                  ? templatesUsersRowList.first
                  : null;
              return SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Theme(
                                                                      ...
                                                                      child:
                                                                          Checkbox(
                                                                        value: _model.checkboxValueMap[listViewUsersRow] ??=
                                                                            listViewUsersRow.produtores!,
                                                                        onChanged:
                                                                            (newValue) async {
                                                                          setState(() =>
                    ...
                    if (templatesUsersRow?.adm == false)
                      Column(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          Padding(
